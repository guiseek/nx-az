...
export class FullscreenService {
  ...
  private fn!: Record<keyof FullscreenControls, any>
  private keyboardAllowed: boolean

  private executor!: Record<string, any>
  ...
  public exit() {
    this.executor[this.fn.exitFullscreen]()
  }
  ...
  public isFullscreen() {
    return Boolean(this.executor[this.fn.fullscreenElement])
  }

  public isEnabled() {
    // Coerce to boolean in case of old WebKit
    return Boolean(this.executor[this.fn.fullscreenEnabled])
  }

  public getElement() {
    return this.executor[this.fn.fullscreenElement]
  }
}
